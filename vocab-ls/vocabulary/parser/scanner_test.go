...
func TestBasicTokenScan(t *testing.T) {
	testScanExpectations(t, []ScanCase{
		...
		{Text: "\n", Expectations: []ScanExpect{{TextValue: "\n", TokenValue: TokenLineBreak, LineOffset: 0, Pos: 1, Line: 1}}},
		{Text: "\r\n", Expectations: []ScanExpect{{TextValue: "\r\n", TokenValue: TokenLineBreak, LineOffset: 0, Pos: 2, Line: 1}}},
		...
		{Text: "(it)", Expectations: []ScanExpect{{TextValue: "it", TokenValue: TokenSemanticSpecifierLiteral, LineOffset: 4, Pos: 4}}},
		{Text: "()", Expectations: []ScanExpect{{TextValue: "", TokenValue: TokenSemanticSpecifierLiteral, LineOffset: 2, Pos: 2}}},
	...
	testScanExpectations(t, []ScanCase{
		...
		},
		{
			...
			Expectations: []ScanExpect{
				{TextValue: ">", TokenValue: TokenGreaterThan, Line: 0, LineOffset: 1, Pos: 1},
				{TextValue: " ", TokenValue: TokenWhitespace, Line: 0, LineOffset: 2, Pos: 2},
				{TextValue: "it", TokenValue: TokenSemanticSpecifierLiteral, Line: 0, LineOffset: 6, Pos: 6},
	...
	testScanExpectations(t, []ScanCase{
		...
		},
		{
			...
			Expectations: []ScanExpect{
				{TextValue: ">>", TokenValue: TokenDoubleGreaterThan, Line: 0, LineOffset: 2, Pos: 2},
				{TextValue: " ", TokenValue: TokenWhitespace, Line: 0, LineOffset: 3, Pos: 3},
				{TextValue: "de", TokenValue: TokenSemanticSpecifierLiteral, Line: 0, LineOffset: 7, Pos: 7},
